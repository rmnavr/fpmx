...
; [F] generate readme content ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn #^ str
        ...
        (sconcat "\n" "This is local version of github.com/rmnavr/fpmx lib.\n"
                      "\n"
                      "Purpose of local version is to have stable fpmx \n"
                      "inside other projects until fpmx reaches stable relsease.\n"
                      "\n"
...
; [F] patch inner imports ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn #^ None
        ...
        "replaces 'fpmx' everywhere to '_fpmx_local', old should be regexed strings"
...
; [F] CONFIG ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (setv $SOURCE_FOLDER        "../../src/fpmx")
    (setv $LOCALS_FOLDER        "../../_etc/local_versions")

    ; v.1 = Normal:
    (setv $LOCAL_FOLDER_NAME    "fpmx_local")
    (setv $REPLACEMENTS         [ [r"fpmx\."       "fpmx_local."]
                                  [r"hy\.R\.fpmx/" "hy.R.fpmx_local/"]
                                ])

    ; v.2 = For wy:
    ; (setv $LOCAL_FOLDER_NAME    "wy.utils.fpmx_local")
    ; (setv $REPLACEMENTS         [ [r"fpmx\."       "wy.utils.fpmx_local."]
    ;                               [r"hy\.R\.fpmx/" "hy.R.wy/utils/fpmx_local/"]
    ;                             ])
    ...
    (setv $FILES_TO_COPY        [ "__init__.py"
                                  ...
                                  "loader.hy"
                                  "prelude/__init__.py"
                                  "prelude/__init__macros.hy"
                                  "prelude/funcs.hy"
                                  "prelude/from_hyrule.hy"
                                  "prelude/macros.hy"
                                  "monads/maybeM.hy"
                                  "monads/resultM.hy"
...
; _____________________________________________________________________________/ }}}1
    ...
    (setv _fpmx_version   (extract_version $SETUP_VERSION_HEADER (read_file $SETUP_PY)))
    (setv _target_folder  (sconcat $LOCALS_FOLDER "/" _fpmx_version "/" $LOCAL_FOLDER_NAME))
    ...
    (setv _readme_content (generate_readme_content _fpmx_version))
    ...
    (try ; -> make dirs
         ...
         (for [[source target] _source_target_files_pairs]
              ...
              (rewrite_file_with_new_lib_name target #* (first  $REPLACEMENTS)) ; fpmx.
              (rewrite_file_with_new_lib_name target #* (second $REPLACEMENTS)) ; hy.R.fpmx/
