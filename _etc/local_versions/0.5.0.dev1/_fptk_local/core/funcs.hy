...
; Import (required for functions def) ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    ;; _fptk_local functions require in their code:
    ;; - of, comment
    ;; - List
...
; [MACRO] Reimported macros ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (require _fptk_local.core.from_hyrule [
    ...
    (require _fptk_local.core.macros [
        ...
        pluckm              #_ "[GROUP] Getters: keys and attrs | (pluckm n xs) (pluckm key ys) (pluckm .attr zs) | accepts _fptk_local-style .arg syntax"
        lpluckm             #_ "[GROUP] Getters: keys and attrs | | list version of pluckm"
        getattrm            #_ "[GROUP] Getters: keys and attrs | (getattrm Object 'attr') (getattrm Object .attr) | accepts _fptk_local-style .attr syntax"
...
; [GROUP] APL: working with lists ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (import _fptk_local.core.from_hyrule [flatten]) #_ "flatten(coll) | recursively flattens to the bottom"
...
; [GROUP] Getters: idxs and keys ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    ;; dub basics:
        ...
        (import _fptk_local.core.from_hyrule [assoc]) #_ "assoc(xs, k1, v1, k2, v2, ...) -> None | ≈ (setv (get xs k1) v1 (get xs k2) v2) ; also possible: (assoc xs :x 1)"
