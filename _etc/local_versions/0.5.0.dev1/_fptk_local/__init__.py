...
# core funcs (import)
_t = _get_time()
from _fptk_local.core.funcs import *
_r2 = f"{(_get_time() - _t) :.3f} sec | core funcs"

# core macros (require)
_t = _get_time()
hy.eval(hy.read(f"(require _fptk_local.core.funcs :macros *)"))
_r3 = f"{(_get_time() - _t) :.3f} sec | core macros"

if _import_lenses:
    _t = _get_time()
    from _fptk_local.lenses import *
    _r4 = f"{(_get_time() - _t) :.3f} sec | lenses"

if _import_strictT:
    _t = _get_time()
    from _fptk_local.strict import *
    _r5 = f"{(_get_time() - _t) :.3f} sec | strict"

if _import_monads:
    _t = _get_time()
    from _fptk_local.monads import *
