...
```hy
Help on function lrange_ in module fptk.mathnlogic:
...
```hy
Help on class Result in module fptk.monads.resultM:

class Result(pydantic.main.BaseModel, typing.Generic)
 |  Result(
 |      *,
 |      result: Union[fptk.monads.resultM._Success, fptk.monads.resultM._Failure]
 |  ) -> None
 |
 ...
 |  __abstractmethods__ = frozenset()
 |
 |  __annotations__ = {'result': typing.Union[fptk.monads.resultM._Success...
 |
 |  __class_vars__ = set()
 |
 |  __orig_bases__ = (<class 'pydantic.main.BaseModel'>, typing.Generic[~S...
 |
 |  __parameters__ = (~S, ~F)
 |
 ...
 |
 |  __pydantic_core_schema__ = {'cls': <class 'fptk.monads.resultM.Result'...
 |
 |  __pydantic_custom_init__ = False
 |
 |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
 |
 |  __pydantic_fields__ = {'result': FieldInfo(annotation=Union[_Success, ...
 |
 ...
 |
 |  __pydantic_validator__ = SchemaValidator(title="Result", validator=Mod...
 |
 |  __signature__ = <Signature (*, result: Union[fptk.monads.resultM._Succ...
 |
 |  model_config = {}
 |
 |  ----------------------------------------------------------------------
 ...
 |  model_computed_fields = {}
 |
 |  model_fields = {'result': FieldInfo(annotation=Union[_Success, _Failur...
 |
 |  ----------------------------------------------------------------------
