...
; Import/Export ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (export :objects [Maybe Just Nothing justQ nothingQ fmapM bindM unwrapJ unwrapJ_or])
...
; Functions ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn #^ bool justQ [#^ Maybe maybeM]
        ...
        (return (isinstance maybeM.container _Just)))

    (defn #^ bool nothingQ [#^ Maybe maybeM]
        (unless (isinstance maybeM Maybe)
            (raise (ERR.NON_MONAD maybeM)))
        (return (isinstance maybeM.container _Nothing)))

    (defn fmapM [monad0 func #* monads]
        ; check arg type correctness:
        (for [&m (+ #(monad0) monads)]
            (unless (isinstance &m Maybe)
                     (raise (ERR.FMAP &m))))
        ; short-circuit:
        (for [&m (+ #(monad0) monads)]
            (when (isinstance &m.container _Nothing)
                   (return Nothing)))
        ;
        (return
            (Just (func monad0.container.value #* (lfor &m monads &m.container.value)))))

    (defn bindM [monad0 func #* monads]
        ...
        (unless (isinstance new_maybe Maybe)
                 (raise (ERR.BIND_F func new_maybe)))
        ;
        (return new_maybe))
    ...
    (defn unwrapJ_or [maybeM default]
        (if (isinstance maybeM.container _Just)
             (return maybeM.container.value)
             (return default)))
