...
; Import (required for functions def) ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (require fpmx.prelude.from_hyrule [comment of])
...
; VimCells have to be named as:
; [GROUP] 99 Title: subtitle

; [GROUP] 00 Checks: math ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
...
; [GROUP] 01 Checks: type checks ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    #_ "ofinstQ(tp, x) | checks directly via (isinstance x tp)"
    (defn ofinstQ [tp x] "checks literally if isinstance(x, tp)" (isinstance x tp))
...
; [GROUP] 12 Math: rounding ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn clip [x lower upper]
        ...
        (when (< upper lower) (raise (ValueError "can't have lower>upper")))
        (max lower (min x upper)))

    (import math [isclose :as approx_eq])   #_ "approx_eq(a, b, *, rel_tol=1e-09, abs_tol=0.0)"

; _____________________________________________________________________________/ }}}1
; [GROUP] 13 Math: squaring ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
...
; [GROUP] 20 Operator to functions: math ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
...
; _____________________________________________________________________________/ }}}1
; [GROUP] 21 Operator to functions: logics ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
...
; _____________________________________________________________________________/ }}}1
; [GROUP] 22 Operator to functions: dunders ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
...
;; bultins
    ...
    (import fpmx.prelude.from_hyrule [assoc]) #_ "assoc(xs, k1, v1, k2, v2, ...) -> None | ≈ (setv (get xs k1) v1 (get xs k2) v2) ; also possible: (assoc xs :x 1)"
...
; _____________________________________________________________________________/ }}}1
; [GROUP] 62 APL: list concatenation ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
