    ...
    (require fptk.core.macros [
        ...
        pluckm              #_ "[GROUP] G05: Getters            | (pluckm n xs) (pluckm key ys) (pluckm .attr zs) | accepts fptk-style .arg syntax"
        lpluckm             #_ "[GROUP] G05: Getters            | | list version of pluckm"
        getattrm            #_ "[GROUP] G05: Getters            | (getattrm Object 'attr') (getattrm Object .attr) | accepts fptk-style .attr syntax"
