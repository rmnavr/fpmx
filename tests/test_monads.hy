...
; Maybe ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn test_maybe [Maybe Just Nothing justQ nothingQ mapM bindM unwrapJ unwrapJ_or]
        ;
    ...
    (test_maybe #* [Maybe Just Nothing justQ nothingQ mapM bindM unwrapJ unwrapJ_or])
